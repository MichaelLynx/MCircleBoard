...
```swift
.package(url: "https://github.com/MichaelLynx/MCircleBoard.git", from: "2.0.2")
```

然后将 `MCircleBoard` 添加到对应 target 的依赖中。
...
Then add `MCircleBoard` to your target dependencies.
